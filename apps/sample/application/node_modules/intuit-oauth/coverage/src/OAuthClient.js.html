...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> OAuthClient.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.54% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>238/260</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">80.3% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>106/132</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>225/243</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L669'></a><a href='#L669'>669</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >    this.logger = winston.createLogger({</span>
      ...
      format: winston.format.combine(
        ...
        winston.format.printf(<span class="fstat-no" title="function not covered" >in</span>fo =&gt; <span class="cstat-no" title="statement not covered" >`${info.timestamp} ${info.level}: ${info.message}`)</span>
      ),
...
OAuthClient.prototype.migrate = function migrate(params) {
  return (new Promise(((resolve) =&gt; {
    params = params || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
    const uri = this.environment.toLowerCase() === 'sandbox' ? <span class="branch-0 cbranch-no" title="branch not covered" >OAuthClient.migrate_sandbox </span>: OAuthClient.migrate_production;
&nbsp;
    const authHeader = this.generateOauth1Sign(objectAssign({}, { method: 'POST', uri }, params));
&nbsp;
    const body = {
      scope: (Array.isArray(params.scope)) ? params.scope.join(' ') : <span class="branch-1 cbranch-no" title="branch not covered" >params.scope,</span>
      redirect_uri: this.redirectUri,
      client_id: this.clientId,
...
<span class="cstat-no" title="statement not covered" >    this.log('error', 'The migrate () threw an exception : ', JSON.stringify(e, null, 2));</span>
<span class="cstat-no" title="statement not covered" >    throw e;</span>
  });
};
&nbsp;
...
&nbsp;
  const authHeader = Object.entries(parameters).reduce((header, [key, val], idx, array) =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (key === 'minorversion') {
...
<span class="cstat-no" title="statement not covered" >    this.log('error', 'The getKeyFromJWKsURI () threw an exception : ', JSON.stringify(e, null, 2));</span>
<span class="cstat-no" title="statement not covered" >    throw e;</span>
  });
};
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Apr 10 2020 16:33:52 GMT-0700 (Pacific Daylight Time)
</div>
</div>
